...
class TestVisitor(unittest.TestCase):
    ...
    def test_create_visitor(self):
        visitor = create_visitor(
            "Victor", 27, "2019-02-02", "17:00", "John", "great person"
        )
    ...
    def test_visitor_details(self):
        ...
        self.assertEqual(
            visitor_by_code.visitor_name, visitor_by_function["visitor_name"]
        )
        self.assertEqual(
            visitor_by_code.visitor_age, visitor_by_function["visitor_age"]
        )
        self.assertEqual(
            visitor_by_code.time_of_visit, visitor_by_function["time_of_visit"]
        )
        self.assertEqual(
            visitor_by_code.date_of_visit, visitor_by_function["date_of_visit"]
        )
