...
class TestVisitor(unittest.TestCase):
    ...
    def test_visitor_details(self):
        ...
        for visitor_object in Visitor.objects:
            ...
            assert visitor_object.visitor_name ==visitor_details(visitor_object.id)["visitor_name"]
            assert visitor_object.visitor_age ==visitor_details(visitor_object.id)["visitor_age"]
            assert visitor_object.date_of_visit ==visitor_details(visitor_object.id)["date_of_visit"]
            assert visitor_object.time_of_visit ==visitor_details(visitor_object.id)["time_of_visit"]
            assert visitor_object.comments ==visitor_details(visitor_object.id)["comments"]
    ...
    def test_update_visitor(self):
        ...
        for visitor_object in Visitor.objects:
            if visitor_object.visitor_name =="Chuck":
                ...
                update_visitor(id[0], "This was chuck", 22, "20-06-2022", "21:00", "Grace", "Good" )
                break
        changed_name = False
        for visitor_object in Visitor.objects:
