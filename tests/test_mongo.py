...
class TestIndex(unittest.TestCase):
    @patch("src.mongo_db.create_visitor")
    ...
    @patch("src.mongo_db.list_visitors")
    ...
    @patch("src.mongo_db.delete_visitor")
    ...
    @patch("src.mongo_db.visitor_details")
    ...
    @patch("src.mongo_db.update_visitor")
